defmodule LiveCalendarWeb.Live.Admin.CreateCalendarLive do
  @moduledoc false
  ...
  def handle_event("validate", %{"calendar" => calendar_params}, socket) do
    form = to_form(Calendar.changeset(%Calendar{}, calendar_params))

    {:noreply, assign(socket, form: form)}
  end

  def handle_event("save", %{"calendar" => calendar_params}, socket) do
    case Calendar.create(calendar_params) do
      {:ok, _calendar} ->
        {:noreply, redirect(socket, to: ~p"/admin/calendars")}
